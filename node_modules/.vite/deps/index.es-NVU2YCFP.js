...
var hr = (t, e) => {
  ...
  const i3 = `URI: ${t.aud || t.uri}`, s = `Version: ${t.version}`, c3 = `Chain ID: ${lr(e)}`, a2 = `Nonce: ${t.nonce}`, u3 = `Issued At: ${t.iat}`, l3 = t.exp ? `Expiration Time: ${t.exp}` : void 0, f6 = t.nbf ? `Not Before: ${t.nbf}` : void 0, h4 = t.requestId ? `Request ID: ${t.requestId}` : void 0, y5 = t.resources ? `Resources:${t.resources.map((p4) => `
- ${p4}`).join("")}` : void 0, E6 = pe(t.resources);
  if (E6) {
    const p4 = yt(E6);
    o2 = Ke(o2, p4);
  }
  return [n2, r2, "", o2, "", i3, s, c3, a2, u3, l3, f6, h4, y5].filter((p4) => p4 != null).join(`
`);
};
function mr(t) {
...
function Ns(t, e) {
  ...
  return Fe(o2), Fe(s), Ar(i3), Ar(n2), (c3, a2, u3, l3, f6 = 0) => {
    ...
    const O4 = mt(a2);
    return Is(t, d3, v5, O4, u3, l3, f6, s), jt(...y5), l3;
  };
}
...
var Us = class {
  ...
  process(e, n2, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: i3, r: s } = this, c3 = s[0], a2 = s[1], u3 = s[2], l3 = s[3], f6 = s[4], h4 = s[5], y5 = s[6], E6 = s[7], p4 = s[8], d3 = s[9], v5 = F(e, n2 + 0), m2 = F(e, n2 + 2), O4 = F(e, n2 + 4), N3 = F(e, n2 + 6), $5 = F(e, n2 + 8), B4 = F(e, n2 + 10), A5 = F(e, n2 + 12), T3 = F(e, n2 + 14);
    ...
    x2 = C6 >>> 13, C6 &= 8191, C6 += g * (5 * h4) + w3 * (5 * f6) + b5 * (5 * l3) + I4 * (5 * u3) + R5 * (5 * a2), x2 += C6 >>> 13, C6 &= 8191;
    let P4 = x2 + S5 * a2 + L4 * c3 + U5 * (5 * d3) + _2 * (5 * p4) + j3 * (5 * E6);
    x2 = P4 >>> 13, P4 &= 8191, P4 += g * (5 * y5) + w3 * (5 * h4) + b5 * (5 * f6) + I4 * (5 * l3) + R5 * (5 * u3), x2 += P4 >>> 13, P4 &= 8191;
    let k6 = x2 + S5 * u3 + L4 * a2 + U5 * c3 + _2 * (5 * d3) + j3 * (5 * p4);
    x2 = k6 >>> 13, k6 &= 8191, k6 += g * (5 * E6) + w3 * (5 * y5) + b5 * (5 * h4) + I4 * (5 * f6) + R5 * (5 * l3), x2 += k6 >>> 13, k6 &= 8191;
    let M5 = x2 + S5 * l3 + L4 * u3 + U5 * a2 + _2 * c3 + j3 * (5 * d3);
    x2 = M5 >>> 13, M5 &= 8191, M5 += g * (5 * p4) + w3 * (5 * E6) + b5 * (5 * y5) + I4 * (5 * h4) + R5 * (5 * f6), x2 += M5 >>> 13, M5 &= 8191;
    let D3 = x2 + S5 * f6 + L4 * l3 + U5 * u3 + _2 * a2 + j3 * c3;
    x2 = D3 >>> 13, D3 &= 8191, D3 += g * (5 * d3) + w3 * (5 * p4) + b5 * (5 * E6) + I4 * (5 * y5) + R5 * (5 * h4), x2 += D3 >>> 13, D3 &= 8191;
    let z3 = x2 + S5 * h4 + L4 * f6 + U5 * l3 + _2 * u3 + j3 * a2;
    x2 = z3 >>> 13, z3 &= 8191, z3 += g * c3 + w3 * (5 * d3) + b5 * (5 * p4) + I4 * (5 * E6) + R5 * (5 * y5), x2 += z3 >>> 13, z3 &= 8191;
    let Z3 = x2 + S5 * y5 + L4 * h4 + U5 * f6 + _2 * l3 + j3 * u3;
    x2 = Z3 >>> 13, Z3 &= 8191, Z3 += g * a2 + w3 * c3 + b5 * (5 * d3) + I4 * (5 * p4) + R5 * (5 * E6), x2 += Z3 >>> 13, Z3 &= 8191;
    let st3 = x2 + S5 * E6 + L4 * y5 + U5 * h4 + _2 * f6 + j3 * l3;
    x2 = st3 >>> 13, st3 &= 8191, st3 += g * u3 + w3 * a2 + b5 * c3 + I4 * (5 * d3) + R5 * (5 * p4), x2 += st3 >>> 13, st3 &= 8191;
    let W4 = x2 + S5 * p4 + L4 * E6 + U5 * y5 + _2 * h4 + j3 * f6;
    x2 = W4 >>> 13, W4 &= 8191, W4 += g * l3 + w3 * u3 + b5 * a2 + I4 * c3 + R5 * (5 * d3), x2 += W4 >>> 13, W4 &= 8191;
    let J4 = x2 + S5 * d3 + L4 * p4 + U5 * E6 + _2 * y5 + j3 * h4;
    x2 = J4 >>> 13, J4 &= 8191, J4 += g * f6 + w3 * l3 + b5 * u3 + I4 * a2 + R5 * c3, x2 += J4 >>> 13, J4 &= 8191, x2 = (x2 << 2) + x2 | 0, x2 = x2 + C6 | 0, C6 = x2 & 8191, x2 = x2 >>> 13, P4 += x2, i3[0] = C6, i3[1] = P4, i3[2] = k6, i3[3] = M5, i3[4] = D3, i3[5] = z3, i3[6] = Z3, i3[7] = st3, i3[8] = W4, i3[9] = J4;
  }
  finalize() {
...
function _s(t, e, n2, r2, o2, i3 = 20) {
  let s = t[0], c3 = t[1], a2 = t[2], u3 = t[3], l3 = e[0], f6 = e[1], h4 = e[2], y5 = e[3], E6 = e[4], p4 = e[5], d3 = e[6], v5 = e[7], m2 = o2, O4 = n2[0], N3 = n2[1], $5 = n2[2], B4 = s, A5 = c3, T3 = a2, S5 = u3, L4 = l3, U5 = f6, _2 = h4, j3 = y5, g = E6, w3 = p4, b5 = d3, I4 = v5, R5 = m2, x2 = O4, C6 = N3, P4 = $5;
  ...
  let k6 = 0;
  r2[k6++] = s + B4 | 0, r2[k6++] = c3 + A5 | 0, r2[k6++] = a2 + T3 | 0, r2[k6++] = u3 + S5 | 0, r2[k6++] = l3 + L4 | 0, r2[k6++] = f6 + U5 | 0, r2[k6++] = h4 + _2 | 0, r2[k6++] = y5 + j3 | 0, r2[k6++] = E6 + g | 0, r2[k6++] = p4 + w3 | 0, r2[k6++] = d3 + b5 | 0, r2[k6++] = v5 + I4 | 0, r2[k6++] = m2 + R5 | 0, r2[k6++] = O4 + x2 | 0, r2[k6++] = N3 + C6 | 0, r2[k6++] = $5 + P4 | 0;
}
...
var Fs = class extends qs {
  ...
  process(e, n2) {
    ...
    for (let f6 = 16; f6 < 64; f6++) {
      const h4 = bt[f6 - 15], y5 = bt[f6 - 2], E6 = ct(h4, 7) ^ ct(h4, 18) ^ h4 >>> 3, p4 = ct(y5, 17) ^ ct(y5, 19) ^ y5 >>> 10;
      bt[f6] = p4 + bt[f6 - 7] + E6 + bt[f6 - 16] | 0;
    }
    let { A: r2, B: o2, C: i3, D: s, E: c3, F: a2, G: u3, H: l3 } = this;
    for (let f6 = 0; f6 < 64; f6++) {
      const h4 = ct(c3, 6) ^ ct(c3, 11) ^ ct(c3, 25), y5 = l3 + h4 + Ds(c3, a2, u3) + Ks[f6] + bt[f6] | 0, p4 = (ct(r2, 2) ^ ct(r2, 13) ^ ct(r2, 22)) + Hs(r2, o2, i3) | 0;
...
function rc(t) {
  ...
  return function(c3, a2) {
    ...
    for (; !c3.eql(h4, c3.ONE); ) {
      ...
      l3 = c3.sqr(E6), f6 = c3.mul(f6, E6), h4 = c3.mul(h4, l3), u3 = y5;
    }
    return f6;
  };
}
...
function gc(t) {
  ...
  function p4(m2, O4) {
    const N3 = y5(O4), $5 = E6(m2), B4 = f6(N3, $5);
...
BigInt(8);
function bc(t) {
  const e = BigInt(10), n2 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), i3 = un, c3 = t * t % i3 * t % i3, a2 = it(c3, Xr, i3) * c3 % i3, u3 = it(a2, yc, i3) * t % i3, l3 = it(u3, wc, i3) * u3 % i3, f6 = it(l3, e, i3) * l3 % i3, h4 = it(f6, n2, i3) * f6 % i3, y5 = it(h4, r2, i3) * h4 % i3, E6 = it(y5, o2, i3) * y5 % i3, p4 = it(E6, o2, i3) * y5 % i3, d3 = it(p4, e, i3) * l3 % i3;
...
function Ic(t) {
  ...
  const { ProjectivePoint: a2, normPrivateKeyToScalar: u3, weierstrassEquation: l3, isWithinCurveOrder: f6 } = Ac({ ...e, toBytes(g, w3, b5) {
...
var Ns2 = class extends V2 {
  constructor(n2) {
    super(n2), c2(this, "name", dt2), c2(this, "events", new import_events4.default()), c2(this, "initialized", false), c2(this, "requestQueue", { state: $2.idle, queue: [] }), c2(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c2(this, "requestQueueDelay", import_time3.ONE_SECOND), c2(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedLimit", 200), c2(this, "relayMessageCache", []), c2(this, "pendingSessions", /* @__PURE__ */ new Map()), c2(this, "init", async () => {
      ...
      const d3 = await this.client.core.crypto.generateKeyPair(), w3 = N.wc_sessionPropose.req.ttl || import_time3.FIVE_MINUTES, m2 = Ei(w3), f6 = b2(v3(v3({ requiredNamespaces: i3, optionalNamespaces: r2, relays: l3 ?? [{ protocol: xt2 }], proposer: { publicKey: d3, metadata: this.client.metadata }, expiryTimestamp: m2, pairingTopic: p4 }, o2 && { sessionProperties: o2 }), a2 && { scopedProperties: a2 }), { id: payloadId() }), _2 = xi("session_connect", f6.id), { reject: g, resolve: A5, done: D3 } = gi(w3, $e2), I4 = ({ id: T3 }) => {
        T3 === f6.id && (this.client.events.off("proposal_expire", I4), this.pendingSessions.delete(f6.id), this.events.emit(_2, { error: { message: $e2, code: 0 } }));
      };
      ...
      const { pairingTopic: w3, proposer: m2, requiredNamespaces: f6, optionalNamespaces: _2 } = d3;
      ...
      const fe3 = b2(v3({}, T3), { topic: I4, requiredNamespaces: f6, optionalNamespaces: _2, pairingTopic: w3, acknowledged: false, self: T3.controller, peer: { publicKey: m2.publicKey, metadata: m2.metadata }, controller: A5, transportType: Q.relay });
      ...
      return await Promise.all([new Promise(async (_2) => {
        await this.sendRequest(v3({ clientRpcId: a2, relayRpcId: l3, topic: i3, method: d3, params: m2, expiry: r2, throwOnFailedPublish: true }, f6 && { tvf: this.getTVFParams(a2, m2) })).catch((g) => u3(g)), this.client.events.emit("session_request_sent", { topic: i3, request: s, chainId: t, id: a2 }), _2();
      ...
      const { chains: o2, statement: a2 = "", uri: l3, domain: p4, nonce: h4, type: u3, exp: d3, nbf: w3, methods: m2 = [], expiry: f6 } = e, _2 = [...e.resources || []], { topic: g, uri: A5 } = await this.client.core.pairing.create({ methods: ["wc_sessionAuthenticate"], transportType: r2 });
      ...
      for (const f6 of s) {
        ...
        const { p: _2 } = f6, g = pe(_2.resources), A5 = [dr(_2.iss)], D3 = De(_2.iss);
        if (g) {
      ...
      try {
        ...
        const { relay: r2, controller: o2, expiry: a2, namespaces: l3, sessionProperties: p4, scopedProperties: h4, sessionConfig: u3 } = t.params, d3 = [...this.pendingSessions.values()].find((f6) => f6.sessionTopic === e);
...
var D2 = async () => {
  const { createAppKit: s } = await import("./core-55ZAM3DM.js");
  return s;
};
...
function G3(s) {
  ...
  const c3 = { chains: t, methods: n2 || f5, events: a2 || C5, rpcMap: v4({}, t.length ? { [I3(t)]: u3[I3(t)] } : {}) }, l3 = a2 == null ? void 0 : a2.filter((d3) => !C5.includes(d3)), r2 = n2 == null ? void 0 : n2.filter((d3) => !f5.includes(d3));
...
var b4 = class _b {
  ...
  getRpcConfig(t) {
    ...
    const u3 = i3.length ? (t == null ? void 0 : t.methods) || f5 : [], c3 = i3.length ? (t == null ? void 0 : t.events) || C5 : [], l3 = (t == null ? void 0 : t.optionalMethods) || [], r2 = (t == null ? void 0 : t.optionalEvents) || [], m2 = (t == null ? void 0 : t.rpcMap) || this.buildRpcMap(o2, t.projectId), h4 = (t == null ? void 0 : t.qrModalOptions) || void 0;
...
*/
//# sourceMappingURL=index.es-NVU2YCFP.js.map
