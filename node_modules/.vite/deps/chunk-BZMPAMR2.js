...
function __asyncGenerator(thisArg, _arguments, generator) {
  ...
  function settle(f5, v4) {
    if (f5(v4), q.shift(), q.length) resume(q[0][0], q[0][1]);
  }
}
function __asyncDelegator(o5) {
  ...
  function verb(n4, f5) {
    i3[n4] = o5[n4] ? function(v4) {
      return (p3 = !p3) ? { value: __await(o5[n4](v4)), done: n4 === "return" } : f5 ? f5(v4) : v4;
    } : f5;
  }
}
...
// node_modules/@wagmi/connectors/node_modules/pino/browser.js
var require_browser = __commonJS({
  "node_modules/@wagmi/connectors/node_modules/pino/browser.js"(exports, module) {
    "use strict";
...
function yr(t) {
  const e2 = gr(t), { Fp: n4, n: r3, prehash: o5, hash: s3, randomBytes: a2, nByteLength: u, h: i3 } = e2, D2 = yt << BigInt(u * 8) - j, c5 = n4.create, l6 = _e(e2.n, e2.nBitLength), p3 = e2.uvRatio || ((y3, f5) => {
    try {
      return { isValid: true, value: n4.sqrt(y3 * n4.inv(f5)) };
    } catch {
      return { isValid: false, value: G };
    }
  }), w4 = e2.adjustScalarBytes || ((y3) => y3), h4 = e2.domain || ((y3, f5, b3) => {
    if (Tt("phflag", b3), f5.length || b3) throw new Error("Contexts/pre-hash are not supported");
    return y3;
  });
  function g4(y3, f5) {
    ft("coordinate " + y3, f5, G, D2);
  }
  function S2(y3) {
  ...
  const v4 = xe((y3, f5) => {
    ...
    f5 == null && (f5 = C3 ? wr : n4.inv(B2));
    const A2 = c5(b3 * f5), U2 = c5(E4 * f5), _3 = c5(B2 * f5);
    ...
    const { ex: E4, ey: B2, ez: C3, et: A2 } = y3, U2 = c5(E4 * E4), _3 = c5(B2 * B2), T3 = c5(C3 * C3), $ = c5(T3 * T3), R = c5(U2 * f5), V = c5(T3 * c5(R + _3)), Y = c5($ + c5(b3 * c5(U2 * _3)));
  ...
  class d4 {
    constructor(f5, b3, E4, B2) {
      this.ex = f5, this.ey = b3, this.ez = E4, this.et = B2, g4("x", f5), g4("y", b3), g4("z", E4), g4("t", B2), Object.freeze(this);
    }
    get x() {
    ...
    static normalizeZ(f5) {
      const b3 = n4.invertBatch(f5.map((E4) => E4.ez));
      return f5.map((E4, B2) => E4.toAffine(b3[B2])).map(d4.fromAffine);
    }
    static msm(f5, b3) {
      return br(d4, l6, f5, b3);
    }
    _setWindowSize(f5) {
      q.setWindowSize(this, f5);
    }
    assertValidity() {
      L3(this);
    }
    equals(f5) {
      S2(f5);
      const { ex: b3, ey: E4, ez: B2 } = this, { ex: C3, ey: A2, ez: U2 } = f5, _3 = c5(b3 * U2), T3 = c5(C3 * B2), $ = c5(E4 * U2), R = c5(A2 * B2);
      return _3 === T3 && $ === R;
    }
    is0() {
    ...
    double() {
      const { a: f5 } = e2, { ex: b3, ey: E4, ez: B2 } = this, C3 = c5(b3 * b3), A2 = c5(E4 * E4), U2 = c5(yt * c5(B2 * B2)), _3 = c5(f5 * C3), T3 = b3 + E4, $ = c5(c5(T3 * T3) - C3 - A2), R = _3 + A2, V = R - U2, Y = _3 - A2, Z = c5($ * V), X = c5(R * Y), et = c5($ * Y), pt = c5(V * R);
      return new d4(Z, X, pt, et);
    }
    add(f5) {
      S2(f5);
      const { a: b3, d: E4 } = e2, { ex: B2, ey: C3, ez: A2, et: U2 } = this, { ex: _3, ey: T3, ez: $, et: R } = f5;
      if (b3 === BigInt(-1)) {
    ...
    wNAF(f5) {
      return q.wNAFCached(this, f5, d4.normalizeZ);
    }
    multiply(f5) {
      const b3 = f5;
      ft("scalar", b3, j, r3);
    ...
    static fromHex(f5, b3 = false) {
      ...
      f5 = W("pointHex", f5, C3), Tt("zip215", b3);
      const A2 = f5.slice(), U2 = f5[C3 - 1];
      A2[C3 - 1] = U2 & -129;
    ...
    toRawBytes() {
      const { x: f5, y: b3 } = this.toAffine(), E4 = Nt(b3, n4.BYTES);
  ...
  function O4(y3) {
    const f5 = n4.BYTES;
    y3 = W("private key", y3, f5);
    const b3 = W("hashed private key", s3(y3), 2 * f5), E4 = w4(b3.slice(0, f5)), B2 = b3.slice(f5, 2 * f5), C3 = I2(E4), A2 = m3.multiply(C3), U2 = A2.toRawBytes();
    return { head: E4, prefix: B2, scalar: C3, point: A2, pointBytes: U2 };
  }
  function ot(y3) {
    return O4(y3).pointBytes;
  }
  function tt(y3 = new Uint8Array(), ...f5) {
    const b3 = ye(...f5);
    return I2(s3(h4(b3, W("context", y3), !!o5)));
  }
  function st(y3, f5, b3 = {}) {
    y3 = W("message", y3), o5 && (y3 = o5(y3));
    const { prefix: E4, scalar: B2, pointBytes: C3 } = O4(f5), A2 = tt(b3.context, E4, y3), U2 = m3.multiply(A2).toRawBytes(), _3 = tt(b3.context, U2, C3, y3), T3 = z3(A2 + _3 * B2);
    ft("signature.s", T3, G, r3);
    const $ = ye(U2, Nt(T3, n4.BYTES));
    return W("result", $, n4.BYTES * 2);
  }
  const at = Er;
  function Ct(y3, f5, b3, E4 = at) {
    const { context: B2, zip215: C3 } = E4, A2 = n4.BYTES;
    y3 = W("signature", y3, 2 * A2), f5 = W("message", f5), b3 = W("publicKey", b3, A2), C3 !== void 0 && Tt("zip215", C3), o5 && (f5 = o5(f5));
    ...
    const R = tt(B2, T3.toRawBytes(), _3.toRawBytes(), f5);
    return T3.add(_3.multiplyUnsafe(R)).subtract($).clearCofactor().equals(d4.ZERO);
  }
  return m3._setWindowSize(8), { CURVE: e2, getPublicKey: ot, sign: st, verify: Ct, ExtendedPoint: d4, utils: { getExtendedPublicKey: O4, randomPrivateKey: () => a2(n4.BYTES), precompute(y3 = 8, f5 = d4.BASE) {
...
// node_modules/@wagmi/connectors/node_modules/uint8arrays/esm/src/alloc.js
...
// node_modules/@wagmi/connectors/node_modules/uint8arrays/esm/src/concat.js
...
// node_modules/@wagmi/connectors/node_modules/uint8arrays/esm/src/util/bases.js
...
// node_modules/@wagmi/connectors/node_modules/uint8arrays/esm/src/from-string.js
...
// node_modules/@wagmi/connectors/node_modules/uint8arrays/esm/src/to-string.js
...
var RIPEMD160 = class extends HashMD {
  ...
  process(view, offset) {
    ...
    for (let group = 0; group < 5; group++) {
      ...
      for (let i3 = 0; i3 < 16; i3++) {
        const tr2 = rotl(ar2 + f3(rGroup, br2, cr2, dr2) + R_BUF[rr2[i3]] + hbr, sr2[i3]) + er2 | 0;
...
// node_modules/@wagmi/connectors/node_modules/unstorage/dist/shared/unstorage.zVDD2mZo.mjs
...
// node_modules/@wagmi/connectors/node_modules/unstorage/dist/index.mjs
...
// node_modules/@wagmi/connectors/node_modules/@walletconnect/keyvaluestorage/dist/index.es.js
var x3 = "idb-keyval";
var z2 = (i3 = {}) => {
...
*/
//# sourceMappingURL=chunk-BZMPAMR2.js.map
