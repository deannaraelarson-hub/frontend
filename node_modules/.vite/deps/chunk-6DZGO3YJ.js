...
async function getBlock(client, { blockHash, blockNumber, blockTag = client.experimental_blockTag ?? "latest", includeTransactions: includeTransactions_ } = {}) {
  ...
  const format4 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.block) == null ? void 0 : _c.format) || formatBlock;
...
async function fillTransaction(client, parameters) {
  ...
  const format4 = chainFormat || formatTransactionRequest;
  const request = format4({
  ...
  try {
    ...
    const format5 = ((_d = (_c = chain == null ? void 0 : chain.formatters) == null ? void 0 : _c.transaction) == null ? void 0 : _d.format) || formatTransaction;
    const transaction = format5(response.tx);
...
async function getTransaction(client, { blockHash, blockNumber, blockTag: blockTag_, hash, index: index2, sender, nonce }) {
  ...
  const format4 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transaction) == null ? void 0 : _c.format) || formatTransaction;
...
async function getTransactionReceipt(client, { hash }) {
  ...
  const format4 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionReceipt) == null ? void 0 : _c.format) || formatTransactionReceipt;
...
async function sendRawTransactionSync(client, { serializedTransaction, throwOnReceiptRevert, timeout }) {
  ...
  const format4 = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.transactionReceipt) == null ? void 0 : _c.format) || formatTransactionReceipt;
  const formatted = format4(receipt);
...
async function signTransaction(client, parameters) {
  ...
  const format4 = ((_b = formatters == null ? void 0 : formatters.transactionRequest) == null ? void 0 : _b.format) || formatTransactionRequest;
...
//# sourceMappingURL=chunk-6DZGO3YJ.js.map
