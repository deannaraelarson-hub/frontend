 ...
 */
export function getTotalPerSecond(config, parameters) {
...
(function (getTotalPerSecond) {
    ...
    getTotalPerSecond.queryKey = queryKey;
    ...
    getTotalPerSecond.queryOptions = queryOptions;
 ...
 * @returns The transaction hash.
 */
export async function start(config, parameters) {
    const { account, chainId, connector } = parameters;
    const client = await getConnectorClient(config, {
        account,
        assertChainId: false,
    ...
    return Actions.reward.start(client, parameters);
}
/**
 ...
 * @returns The transaction receipt and event data.
 */
export async function startSync(config, parameters) {
    const { account, chainId, connector } = parameters;
    const client = await getConnectorClient(config, {
        account,
        assertChainId: false,
    ...
    return Actions.reward.startSync(client, parameters);
}
/**
 ...
 */
export function watchRewardScheduled(config, parameters) {
    const { chainId, ...rest } = parameters;
    const client = config.getClient({ chainId });
