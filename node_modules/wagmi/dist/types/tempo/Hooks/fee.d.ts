...
export declare namespace useUserToken {
    type Parameters<config extends Config = ResolvedRegister['config'], selectData = Actions.fee.getUserToken.ReturnValue> = ConfigParameter<config> & QueryParameter<Actions.fee.getUserToken.ReturnValue, Actions.fee.getUserToken.ErrorType, selectData, Actions.fee.getUserToken.QueryKey<config>> & Omit<Actions.fee.getUserToken.queryOptions.Parameters<config, selectData>, 'query'>;
